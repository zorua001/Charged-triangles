...
SIMULATION_PARAMS = {
    ...
    'bodies': [Body('cylinder', float(5),pos=[5,0,0],rot=[1.5,0,0], radius=1, height=5,length_resolution=20, height_resolution=20),Body('cylinder',float(10), pos=[0,0,0],rot=[0,0,0], radius=1, height=5,length_resolution=20, height_resolution=20) ]
}