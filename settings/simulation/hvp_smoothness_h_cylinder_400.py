# -*- coding: utf-8 -*-
"""
Created on Wed Dec 17 12:49:22 2025
...
SIMULATION_PARAMS = {
    'name': 'hvp_smoothness_h_cylinder_400',
    ...
    'bodies': [Body('cylinder', float(1), pos=[0,0,0],rot=[0,0,0], radius=10, height=50,radius_resolution=20, height_resolution=20),],
