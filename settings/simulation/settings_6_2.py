# -*- coding: utf-8 -*-
"""
Created on Fri Dec 19 11:22:46 2025
...
SIMULATION_PARAMS = {
    'name': 'box_cylinder_cylinder_point_offset(5)_2',
    ...
    'bodies': ([
        Body('cylinder', float(5), pos=[.25,.25,-2.5],rot=[0,0,0], radius=0.25, height=5,length_resolution=20, height_resolution=20),
