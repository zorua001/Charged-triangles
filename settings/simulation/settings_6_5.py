# -*- coding: utf-8 -*-
"""
Created on Fri Dec 19 11:32:08 2025
...
SIMULATION_PARAMS = {
    'name': 'box_cylinder_cylinder_point_offset(5)_5',
    ...
    'bodies': ([
        ...
        Body('box', float(5) ,pos = [0,0,0],rot =[0,0,0], height=3 , width = 3, depth = 3, iterations = 2 ),
