# -*- coding: utf-8 -*-
"""
Created on Fri Dec 19 11:27:23 2025
...
SIMULATION_PARAMS = {
    'name': 'box_cylinder_cylinder_point_offset(5)_3',
    ...
    'bodies': ([
        Body('cylinder', float(5), pos=[.25,.25,-2.5],rot=[0,0,0], radius=0.25, height=5,length_resolution=40, height_resolution=40),
        Body('box', float(5) ,pos = [0,0,0],rot =[0,0,0], height=3 , width = 3, depth = 3, iterations = 3 ),
        Body('cylinder', float(5), pos=[2.75,.25,-2.5],rot=[0,0,0], radius=0.25, height=5,length_resolution=40, height_resolution=40)
        ]),
